...
local function onPvpSelected()
    ...
    task.spawn(function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/HiIxX0Dexter0XxIiH/BRM5-Script-Definitive-Edition/main/brm5-pvp/BRM5-PVP.lua?v=" .. tostring(os.time())))()
    end)
end
...
local function onPveSelected()
    ...
    -- Ejecutar script en segundo plano
    task.spawn(function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/HiIxX0Dexter0XxIiH/BRM5-Script-Definitive-Edition/main/brm5-pve/loader_github.lua?v=" .. tostring(os.time())))()
    end)
end
